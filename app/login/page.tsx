    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary p-12 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg text-center">
          ...
          <h1 className="text-4xl font-bold text-white mb-4 text-balance">Your client portal, simplified</h1>
          <p className="text-lg text-white/80 text-balance">
            Manage projects, share files, and communicate with clients all in one place. Built for modern freelancers.
          </p>
        </div>
      </div>
